...
pub trait Eng {
    ...
    fn set_ponder(&mut self, is_enabled: bool) -> Result<(), UziErr>;
    fn set_own_book(&mut self, is_enabled: bool) -> Result<(), UziErr>;
    ...
    fn set_analysis(&mut self, is_enabled: bool) -> Result<(), UziErr>;
